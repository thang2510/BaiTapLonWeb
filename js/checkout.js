document.addEventListener('DOMContentLoaded', function () {
    function printSeatMan(posSeat, typeSeat) {
        ...
        '<div class="col-1"><div class="seatroom__pos__item">' + posSeat + '</div></div>' +
        '<div class="col-2 px-0">' +
            '<div class="seatroom__pos">' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
            '</div>' +
        ...
        '<div class="col-8 px-0">' +
            '<div class="seatroom__pos jus-center ' + typeSeat + '">' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
        ...
        '<div class="col-1 px-0">' +
            '<div class="seatroom__pos jus-end">' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
                '<div class="seatroom__pos__item"><i class="border-square"></i><i class="fa fa-square"></i></div>' +
            '</div>' +
        '</div>' +
    ...
    getDataFormJson("./data/checkout.json", function(text){
        ...
        for (i = 0; i < data.Position.length; i++) {
            let posName = data.Position[i].PositionName;
    ...
    function appendPaymetATM() {
        var listPaymentATM = ['abbank.jpg', 'acb.jpg', 'agribank.jpg', 'vrb.jpg', 'baoviet.jpg', 'bidv.jpg', 'donga.jpg', 'eximbank.jpg', 'gpbank.jpg', 'hdbank.jpg',
        'kienlongbank.jpg', 'lienvietpostbank.jpg', 'maritimebank.jpg', 'mb.jpg', 'namabank.jpg', 'ncb.jpg', 'ocb.jpg', 'oceanbank.jpg', 'pgbank.jpg', 'publicbank.jpg',
        'pvcombank.jpg', 'sacombank.jpg', 'saigonbank.jpg', 'scb.jpg', 'seabank.jpg', 'shb.jpg', 'techcombank.jpg', 'tpbank.jpg', 'vib.jpg', 'vietabank.jpg',
        'vietcapitalbank.jpg', 'vietcombank.jpg', 'vietinbank.jpg', 'vpbank.jpg'];
        var strPaymentATM = '';
    ...
    document.querySelectorAll('.ckinfor__payment__type').forEach(el => {
...
window.onload = function() {
    ...
    document.querySelectorAll('.seatroom__pos .seatroom__pos__item').forEach(el => {
        let sum = 0;
        el.addEventListener('click', function() {
    ...
    document.querySelectorAll('.seatroom__pos.seatroom__pos__vip .seatroom__pos__item').forEach(el => {
        let sum = 0;
        el.addEventListener('click', function() {
            el.classList.add('active');
    ...
    document.querySelectorAll('.seatroom__pos.seatroom__pos__deluxe .seatroom__pos__item').forEach(el => {
        let sum = 0;
        el.addEventListener('click', function() {
            el.classList.add('active');
